        ...
        <article >
          ...
          <section class="container">
            <section>
              ...
              <a href="{{route('showProduct', $categorie->id)}}">
                <img src="{{ asset('images/' . $categorie->url_image ) }}"/>
              </a>
                
            </section>
          </section>
          <div>
            <div><a href="{{route('showProduct', $categorie->id)}}">{{$categorie->Title}}</a></div>
            <span>{{$categorie->Price}}</span>
          </div>
